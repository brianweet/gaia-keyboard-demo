...
var TouchEventRenderer = (function () {
    ...
    TouchEventRenderer.prototype.findEventIdx = function (data, startIndex, findChar, fromCoords) {
        ...
        for (var i = startIndex; i < data.length; i++) {
            ...
            var eventCharCode;
            if (fromCoords) {
                eventCharCode = (/^[a-zA-Z\s]$/.test(findChar)) ? this.keyboard.charCodeFromCoordinates(e.screenX, e.screenY) : e.keycode;
            }
            else {
...
var Keyboard = (function () {
    ...
    Keyboard.prototype.charCodeFromCoordinates = function (x, y) {
        ...
        for (var i = 0; i < this.keys.length; ++i) {
            ...
            if ((dim.x <= x && dim.x + dim.width > x) && (dim.y <= y && dim.y + dim.height > y)) {
                return key.code;
            }
        }
        return;
    ...
    Keyboard.prototype._getKeyDimensions = function (key) {
